...
class FrankaMoveIt {
public:
    FrankaMoveIt(rclcpp::Node::SharedPtr node_ptr)
    : node_ptr(node_ptr),
            ...
            "ee_link_name", "panda_link8"))
    {
        ...
        RL_imu_subscriber = node_ptr->create_subscription<Imu>(
            "RL_myo/imu", 1,
            std::bind(&FrankaMoveIt::RL_imu_callback_, this,
            std::placeholders::_1));
...
private:
    ...
    void RL_imu_callback_(const geometry_msgs::msg::PoseArray &point_msg) {
